...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExoLegs = { UE4CodeGen_Private::EPropertyClass::Object, "ExoLegs", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020005, 1, nullptr, STRUCT_OFFSET(AExoBody, ExoLegs), Z_Construct_UClass_AExoPart_NoRegister, METADATA_PARAMS(NewProp_ExoLegs_MetaData, ARRAY_COUNT(NewProp_ExoLegs_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExoHip = { UE4CodeGen_Private::EPropertyClass::Object, "ExoHip", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020005, 1, nullptr, STRUCT_OFFSET(AExoBody, ExoHip), Z_Construct_UClass_AExoPart_NoRegister, METADATA_PARAMS(NewProp_ExoHip_MetaData, ARRAY_COUNT(NewProp_ExoHip_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExoHandRight = { UE4CodeGen_Private::EPropertyClass::Object, "ExoHandRight", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020005, 1, nullptr, STRUCT_OFFSET(AExoBody, ExoHandRight), Z_Construct_UClass_AExoHand_NoRegister, METADATA_PARAMS(NewProp_ExoHandRight_MetaData, ARRAY_COUNT(NewProp_ExoHandRight_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExoHandLeft = { UE4CodeGen_Private::EPropertyClass::Object, "ExoHandLeft", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020005, 1, nullptr, STRUCT_OFFSET(AExoBody, ExoHandLeft), Z_Construct_UClass_AExoHand_NoRegister, METADATA_PARAMS(NewProp_ExoHandLeft_MetaData, ARRAY_COUNT(NewProp_ExoHandLeft_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExoArmRight = { UE4CodeGen_Private::EPropertyClass::Object, "ExoArmRight", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020005, 1, nullptr, STRUCT_OFFSET(AExoBody, ExoArmRight), Z_Construct_UClass_AExoArm_NoRegister, METADATA_PARAMS(NewProp_ExoArmRight_MetaData, ARRAY_COUNT(NewProp_ExoArmRight_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExoArmLeft = { UE4CodeGen_Private::EPropertyClass::Object, "ExoArmLeft", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020005, 1, nullptr, STRUCT_OFFSET(AExoBody, ExoArmLeft), Z_Construct_UClass_AExoArm_NoRegister, METADATA_PARAMS(NewProp_ExoArmLeft_MetaData, ARRAY_COUNT(NewProp_ExoArmLeft_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExoTorso = { UE4CodeGen_Private::EPropertyClass::Object, "ExoTorso", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020005, 1, nullptr, STRUCT_OFFSET(AExoBody, ExoTorso), Z_Construct_UClass_AExoPart_NoRegister, METADATA_PARAMS(NewProp_ExoTorso_MetaData, ARRAY_COUNT(NewProp_ExoTorso_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExoHead = { UE4CodeGen_Private::EPropertyClass::Object, "ExoHead", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020005, 1, nullptr, STRUCT_OFFSET(AExoBody, ExoHead), Z_Construct_UClass_AExoPart_NoRegister, METADATA_PARAMS(NewProp_ExoHead_MetaData, ARRAY_COUNT(NewProp_ExoHead_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AExoBody, 3951340371);
